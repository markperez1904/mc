...
6. ***Required***: Install latest forge version for 1.12.2 ([macOS/Linux download](https://github.com/markperez1904/mc/raw/master/forge-1.12.2-14.23.5.2854-installer.jar)) ([Windows download](https://files.minecraftforge.net/maven/net/minecraftforge/forge/1.12.2-14.23.5.2847/forge-1.12.2-14.23.5.2847-installer-win.exe))
